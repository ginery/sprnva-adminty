...
<head>
	...
	<link rel="stylesheet" href="<?= public_url('/assets/adminty/bower_components/font-awesome/css/all.min.css ') ?>" type="text/css">
	...
	<!-- datatables -->
	<script src="<?= public_url('/assets/adminty/bower_components/datatables.net/js/jquery.dataTables.js') ?>"></script>
	...
	<script src="<?= public_url('/assets/adminty/bower_components/datatables.net-bs4/js/dataTables.bootstrap4.js') ?>"></script>
